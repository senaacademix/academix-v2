...
interface AdminScheduleNoveltiesPageProps {
  params: Promise<{
    id: string;
  }>;
}

export default async function AdminScheduleNoveltiesPage({ params }: AdminScheduleNoveltiesPageProps) {
  ...
  return (
    <ScheduleNoveltiesManagerView
      ...
      baseUrl="/dashboard/admin/schedules"
    />
  );
}
